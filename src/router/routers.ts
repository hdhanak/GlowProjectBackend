...
import { createProduct, deleteProduct, getProducts, login, nodemailerMail, register, sendMail, updateProduct } from '../controller/logic'
...
router.get('/nodemailerMail',nodemailerMail)
